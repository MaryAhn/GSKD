...
def parse_args():
    ...
    # checkpoint and log
    parser.add_argument('--pretrained', type=str, default='/home/cvlab/nfs_clientshare/keonhee/code/DIST_KD/chkpt/GT/SOTA_dist_desc_ss_gt_16_40k_desc_10.0_N_8/kd_deeplabv3_resnet18_citys_best_model.pth',
    ...
    def eval(self):
        ...
        if self.num_gpus > 1:
            ...
            for i in range(IoU.shape[0]):
                logger.info("class {:d}, IoU: {:.3f}".format(i, IoU[i].item() * 100))
