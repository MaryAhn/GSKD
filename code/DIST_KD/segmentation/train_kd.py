...
def parse_args():
    ...
    parser.add_argument("--desc-temperature", type=float, default=1.0, help="logits KD temperature")
    
    parser.add_argument("--lambda-kd", type=float, default=1., help="lambda_kd")
    parser.add_argument("--lambda-desc", type=float, default=0.5, help="lambda_desc")
