...
def main():
    ...
    if args.kd != '':
        ...
        # build kd loss
        from lib.models.losses.gskd_loss import KDLoss
        loss_fn = KDLoss(model, teacher_model, loss_fn, args.kd, args.model, args.teacher_model, args.ori_loss_weight, args.kd_loss_weight,
                         args.gskd_loss_weight, args.gskd_temperature, N=args.N, S=args.S, distill_layer=args.distill_layer)
