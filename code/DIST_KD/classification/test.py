...
from lib.dataset.builder import build_dataloader, build_val_dataloader
...
def main():
    ...
    val_dataset, val_loader = build_val_dataloader(args=args)
...
def validate(args, epoch, model, loader, loss_fn, log_suffix=''):
    ...
    for batch_idx, (input, target) in enumerate(loader):
        with torch.no_grad():
            ...
            output, output_feat = model(input)
