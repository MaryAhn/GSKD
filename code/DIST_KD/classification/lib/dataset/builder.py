...
from lib.utils.distributed import *
...
def build_dataloader(args):
    ...
    if args.dataset == 'imagenet':
        ...
        train_dataset = datasets.ImageFolder(
            os.path.join(args.data_path, 'train'), transform=train_transforms_l)
    elif args.dataset == 'cifar10':
    ...
    if args.dataset == 'imagenet':
        ...
        val_dataset = datasets.ImageFolder(os.path.join(args.data_path, 'val'), transform=val_transforms_l)
    elif args.dataset == 'cifar10':
