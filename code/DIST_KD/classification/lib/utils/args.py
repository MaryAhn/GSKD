...
config_parser.add_argument('-c', '--config', default='configs/strategies/distill/resnet_dist_b1_test.yaml', type=str,
...
parser.add_argument('--dataset', default='imagenet', type=str, choices=['cifar10', 'cifar100', 'imagenet'],
                    help='Dataset to use')
parser.add_argument('--data-path', default='/home/cvlab/datasets/ImageNet', type=str,
                    help='Path to load dataset')
parser.add_argument('--model', default='mobilenet_v1', type=str,
...
parser.add_argument('--decay-rate', '--dr', type=float, 
                    help='LR decay rate')
parser.add_argument('--decay-by-epoch', action='store_true', default=False,
...
# KD
parser.add_argument('--kd', type=str, default='', help='Knowledge distillation method. Default: disable')
parser.add_argument('--distill-layer', type=int, default=-1, help='distillation layer, -1 is last')
parser.add_argument('--gskd-temperature', type=float, default=1.0, help='temperature of KL in gskd loss')
parser.add_argument('--gskd-loss-weight', type=float, default=1.0, help='gskd weight')
parser.add_argument("--N", type=int, default=16, help="sampling number")
parser.add_argument("--S", type=int, default=8, help="stride")


parser.add_argument('--teacher-model', type=str, default='resnet34.tv_in1k',
...
parser.add_argument('--kd-loss-weight', type=float, default=2.,
